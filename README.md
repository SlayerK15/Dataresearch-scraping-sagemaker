...
| --------------- | ---------------------------------------------------------------- | ------ |
| **Scraper**     | Autoscale, API, scrape any URL, send raw HTML to MongoDB 1       | ❌      |
...
| **SageMaker 2** | Data analysis, user preference, visualization, API for dashboard | ❌      |
| **Dashboard**   | Input URLs, trigger scrape, visualize results, request analysis  | ❌      |
